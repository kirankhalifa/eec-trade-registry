...
export default async function StaffCompliancePage({ searchParams }: Props) {
  ...
  return <main className="staff-main">
    <header className="staff-page-header"><div><p className="eyebrow">Due process · restricted workspace</p><h1>Compliance casework</h1><p>Record inspections, allegations, evidence, explicit findings, actions, and appeals without treating an allegation as guilt.</p></div><div className="staff-button-row"><Link className="button button-secondary" href="/staff/operations">System health</Link></div></header>
